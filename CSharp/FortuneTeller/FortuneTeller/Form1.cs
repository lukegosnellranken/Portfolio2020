...
{
    public partial class FormFortuneTeller : Form
    {
        string[] fortuneArray =
        {
        ...
        string imageFileName1 = "Closed.jpg";
        string imageFileName2 = "Broken.jpg";
        int _ticks = 0;

        public FormFortuneTeller()
        {
            InitializeComponent();
        }

        private void buttonFortuneCookie_Click(object sender, EventArgs e)
        {
            buttonFortuneCookie.Image = System.Drawing.Image.FromFile(@"C:\Users\lukeg\Desktop\AWD 1100\csharpexercisesnew\Chapter 7\FortuneTeller\images\" + imageFileName2);

            textBoxFortune.Text = findYourFortune();
        ...
        {
            buttonFortuneCookie.Image = System.Drawing.Image.FromFile(@"C:\Users\lukeg\Desktop\AWD 1100\csharpexercisesnew\Chapter 7\FortuneTeller\images\" + imageFileName1);
            timer1.Enabled = false;
        }

        private string findYourFortune()
        {
            Random rand = new Random();
            int randNum = rand.Next(0, fortuneArray.Length);
        ...
        private void FormFortuneTeller_Load(object sender, EventArgs e)
        {
            buttonFortuneCookie.Image = System.Drawing.Image.FromFile(@"C:\Users\lukeg\Desktop\AWD 1100\csharpexercisesnew\Chapter 7\FortuneTeller\images\" + imageFileName1);
            textBoxFortune.Text = "";
        }
